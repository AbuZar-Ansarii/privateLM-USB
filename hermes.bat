...
set "BRIGHT_PURPLE=%ESC%[95m"
set "GRAY=%ESC%[90m"

echo %BRIGHT_CYAN%===================================================%RESET%
echo %BOLD%%BRIGHT_PURPLE%                   THEVOIDKERNEL%RESET%
echo %BRIGHT_CYAN%===================================================%RESET%
echo %GRAY%[ ⚕ Hermes Agent - Portable Workspace Setup ^& Run ]%RESET%
echo.
...
REM Resolve portable root (directory containing Hermes folder)
set "PORTABLE_ROOT=%~dp0Hermes"
