...
echo -e "${BOLD}${BRIGHT_PURPLE}                   THEVOIDKERNEL${RESET}"
echo -e "${BRIGHT_CYAN}===================================================${RESET}"
echo -e "${GRAY}[ ⚕ Hermes Agent - Portable Workspace Setup & Run ]${RESET}"
echo ""
...
# Resolve portable root (directory containing Hermes folder)
PORTABLE_ROOT="$(cd "$(dirname "$0")" && pwd)/Hermes"
